...
async function extractSources() {
  ...
  if (!fs.existsSync(mapFile)) {
    console.error('package/cli.js.map is not included in this deployment-focused repository.');
    console.error('This script is only useful for source-map extraction workflows.');
    process.exitCode = 1;
    return;
  }
